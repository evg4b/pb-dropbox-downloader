...
//go:generate minimock -i pb-dropbox-downloader/internal/synchroniser.DataStorage -o ./testing/mocks\data_storagemock.go -n DataStorageMock
...
// DataStorageMock implements synchroniser.DataStorage
type DataStorageMock struct {
	t minimock.Tester

	funcAdd          func(s1 string, s2 string) (err error)
	...
	funcFromMap          func(m1 map[string]string)
	...
	funcGet          func(s1 string) (s2 string, err error)
	inspectFuncGet   func(s1 string)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mDataStorageMockGet

	funcKeyExists          func(s1 string) (b1 bool, err error)
	...
	funcRemove          func(s1 string) (err error)
...
// NewDataStorageMock returns a mock for synchroniser.DataStorage
...
type DataStorageMockAddExpectation struct {
	...
	results *DataStorageMockAddResults
	Counter uint64
}
...
// DataStorageMockAddResults contains results of the DataStorage.Add
type DataStorageMockAddResults struct {
	err error
}
...
func (mmAdd *mDataStorageMockAdd) Return(err error) *DataStorageMock {
	if mmAdd.mock.funcAdd != nil {
		mmAdd.mock.t.Fatalf("DataStorageMock.Add mock is already set by Set")
	}
	...
	mmAdd.defaultExpectation.results = &DataStorageMockAddResults{err}
	return mmAdd.mock
}

//Set uses given function f to mock the DataStorage.Add method
func (mmAdd *mDataStorageMockAdd) Set(f func(s1 string, s2 string) (err error)) *DataStorageMock {
	if mmAdd.defaultExpectation != nil {
...
// When sets expectation for the DataStorage.Add which will trigger the result defined by the following
// Then helper
func (mmAdd *mDataStorageMockAdd) When(s1 string, s2 string) *DataStorageMockAddExpectation {
	if mmAdd.mock.funcAdd != nil {
		mmAdd.mock.t.Fatalf("DataStorageMock.Add mock is already set by Set")
	}

	expectation := &DataStorageMockAddExpectation{
		mock:   mmAdd.mock,
		params: &DataStorageMockAddParams{s1, s2},
	}
	mmAdd.expectations = append(mmAdd.expectations, expectation)
	return expectation
}

// Then sets up DataStorage.Add return parameters for the expectation previously defined by the When method
func (e *DataStorageMockAddExpectation) Then(err error) *DataStorageMock {
	e.results = &DataStorageMockAddResults{err}
	return e.mock
}

// Add implements synchroniser.DataStorage
func (mmAdd *DataStorageMock) Add(s1 string, s2 string) (err error) {
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		if mm_results == nil {
			mmAdd.t.Fatal("No results are set for the DataStorageMock.Add")
		}
		return (*mm_results).err
	}
	if mmAdd.funcAdd != nil {
		return mmAdd.funcAdd(s1, s2)
	}
...
// Commit implements synchroniser.DataStorage
...
func (mmFromMap *mDataStorageMockFromMap) Return() *DataStorageMock {
	if mmFromMap.mock.funcFromMap != nil {
		mmFromMap.mock.t.Fatalf("DataStorageMock.FromMap mock is already set by Set")
	}
...
func (mmFromMap *mDataStorageMockFromMap) Set(f func(m1 map[string]string)) *DataStorageMock {
	if mmFromMap.defaultExpectation != nil {
...
// FromMap implements synchroniser.DataStorage
func (mmFromMap *DataStorageMock) FromMap(m1 map[string]string) {
...
func (mmGet *mDataStorageMockGet) Return(s2 string, err error) *DataStorageMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("DataStorageMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &DataStorageMockGetResults{s2, err}
	return mmGet.mock
}

//Set uses given function f to mock the DataStorage.Get method
func (mmGet *mDataStorageMockGet) Set(f func(s1 string) (s2 string, err error)) *DataStorageMock {
	if mmGet.defaultExpectation != nil {
...
func (e *DataStorageMockGetExpectation) Then(s2 string, err error) *DataStorageMock {
	e.results = &DataStorageMockGetResults{s2, err}
	return e.mock
}

// Get implements synchroniser.DataStorage
func (mmGet *DataStorageMock) Get(s1 string) (s2 string, err error) {
...
func (mmKeyExists *mDataStorageMockKeyExists) Return(b1 bool, err error) *DataStorageMock {
	if mmKeyExists.mock.funcKeyExists != nil {
		mmKeyExists.mock.t.Fatalf("DataStorageMock.KeyExists mock is already set by Set")
	}
	...
	mmKeyExists.defaultExpectation.results = &DataStorageMockKeyExistsResults{b1, err}
	return mmKeyExists.mock
}

//Set uses given function f to mock the DataStorage.KeyExists method
func (mmKeyExists *mDataStorageMockKeyExists) Set(f func(s1 string) (b1 bool, err error)) *DataStorageMock {
	if mmKeyExists.defaultExpectation != nil {
...
func (e *DataStorageMockKeyExistsExpectation) Then(b1 bool, err error) *DataStorageMock {
	e.results = &DataStorageMockKeyExistsResults{b1, err}
	return e.mock
}

// KeyExists implements synchroniser.DataStorage
func (mmKeyExists *DataStorageMock) KeyExists(s1 string) (b1 bool, err error) {
...
type DataStorageMockRemoveExpectation struct {
	...
	results *DataStorageMockRemoveResults
	Counter uint64
}
...
// DataStorageMockRemoveResults contains results of the DataStorage.Remove
type DataStorageMockRemoveResults struct {
	err error
}
...
func (mmRemove *mDataStorageMockRemove) Return(err error) *DataStorageMock {
	if mmRemove.mock.funcRemove != nil {
		mmRemove.mock.t.Fatalf("DataStorageMock.Remove mock is already set by Set")
	}
	...
	mmRemove.defaultExpectation.results = &DataStorageMockRemoveResults{err}
	return mmRemove.mock
}

//Set uses given function f to mock the DataStorage.Remove method
func (mmRemove *mDataStorageMockRemove) Set(f func(s1 string) (err error)) *DataStorageMock {
	if mmRemove.defaultExpectation != nil {
...
// When sets expectation for the DataStorage.Remove which will trigger the result defined by the following
// Then helper
func (mmRemove *mDataStorageMockRemove) When(s1 string) *DataStorageMockRemoveExpectation {
	if mmRemove.mock.funcRemove != nil {
		mmRemove.mock.t.Fatalf("DataStorageMock.Remove mock is already set by Set")
	}

	expectation := &DataStorageMockRemoveExpectation{
		mock:   mmRemove.mock,
		params: &DataStorageMockRemoveParams{s1},
	}
	mmRemove.expectations = append(mmRemove.expectations, expectation)
	return expectation
}

// Then sets up DataStorage.Remove return parameters for the expectation previously defined by the When method
func (e *DataStorageMockRemoveExpectation) Then(err error) *DataStorageMock {
	e.results = &DataStorageMockRemoveResults{err}
	return e.mock
}

// Remove implements synchroniser.DataStorage
func (mmRemove *DataStorageMock) Remove(s1 string) (err error) {
	...
	if mmRemove.RemoveMock.defaultExpectation != nil {
		...
		if mm_results == nil {
			mmRemove.t.Fatal("No results are set for the DataStorageMock.Remove")
		}
		return (*mm_results).err
	}
	if mmRemove.funcRemove != nil {
		return mmRemove.funcRemove(s1)
	}
...
// ToMap implements synchroniser.DataStorage
